...
namespace ReverseFriendlyFire
{
    public sealed class Config : IConfig
    {
        ...
        [Description("What death message should shown to player when dying due to Damage Reversing?")]
        public string ReverseDamageReason { get; set; } = "Teamkilling";
        [Description("What hint should shown to player when Damage Reversing is activated?")]
